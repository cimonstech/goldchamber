...
const NAV_ITEMS = [
  ...
  { icon: Award, label: "My Certificate", href: "/portal/certificate" },
  { icon: User, label: "My Profile", href: "/portal/profile" },
  { icon: FileText, label: "Documents", href: "/portal/documents" },
  { icon: TrendingUp, label: "Gold Prices", href: "/portal/prices" },
  { icon: Newspaper, label: "Announcements", href: "/portal/news" },
...
const PAGE_TITLES: Record<string, string> = {
  ...
  "/portal/certificate": "My Certificate",
  "/portal/profile": "My Profile",
  "/portal/documents": "Documents",
  "/portal/prices": "Gold Prices",
  "/portal/news": "Announcements",
  "/portal/renewal": "Renewal",
    ...
    supabase.auth.getUser().then(({ data: { user } }) => {
      ...
      supabase
        ...
        .then(({ data }) => {
          ...
          else setProfile({ full_name: user.user_metadata?.full_name ?? null, email: user.email ?? "", membership_tier: null });
        }, () => setProfile({ full_name: user.user_metadata?.full_name ?? null, email: user.email ?? "", membership_tier: null }));
    });
  }, []);
        ...
        {profile && (
          ...
          >
            ...
            {profile.membership_tier && (
              <span
                className="inline-block mt-1 px-2 py-0.5 rounded font-sans text-[9px] uppercase"
                style={{
            ...
            <p className="text-[10px] truncate mt-1">{profile.email}</p>
          </div>
        )}
        <button
          type="button"
